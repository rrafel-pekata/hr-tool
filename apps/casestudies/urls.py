...
urlpatterns = [
    ...
    path('delete/<uuid:ccs_pk>/', views.casestudy_delete, name='casestudy_delete'),
    path('bulk-pdf/<uuid:position_pk>/', views.casestudies_bulk_pdf, name='casestudies_bulk_pdf'),
